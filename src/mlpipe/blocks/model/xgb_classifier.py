...
try:
    ...
    # Create a dummy class for when XGBoost isn't available
    class XGBClassifier:
        def __init__(self, **kwargs):
            raise ImportError("XGBoost not available. Install with: pip install xgboost")

# Conditional class definition and registration
if XGBOOST_AVAILABLE:
    ...
    class XGBClassifierBlock(ModelBlock):
        ...
        def __init__(self, **kwargs):
            ...
            self.model = None  # XGBClassifier | None = None
    ...
    # Unregistered fallback class when XGBoost isn't available
    class XGBClassifierBlock(ModelBlock):
        """XGBoost classifier block that requires XGBoost to be installed."""
        
        def __init__(self, **kwargs):
            raise ImportError(
                "XGBoost not available. Install with: pip install xgboost\n"
                "Or use pip install mlpipe[xgboost] to install with XGBoost support."
            )
